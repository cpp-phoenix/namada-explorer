...
function Blocks () {
    ...
    return (
        <div className="flex-1 flex flex-col text-white items-center justify-start ">
            <div className='lg:flex-1 py-2 flex flex-col rounded-[15px] w-screen md:min-w-[730px] md:max-w-[930px] lg:min-w-[930px] xl:min-w-[1200px] h-[35rem] sm:h-[45rem] bg-[#1A1A1A]'>
